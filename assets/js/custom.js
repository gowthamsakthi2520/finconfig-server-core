...
// emi calculater
$("#amount, #interest, #years, #amount2").on("input change", function() {
		...
		const monthlyPayment = document.querySelector(".emical");
		const sliderValue = document.querySelector(".value1");
		const loanyear = document.querySelector(".loanyear");
		...
		const totalloanamount = document.querySelector(".totalloanamount");

		const principal = parseFloat(amount.value);
		const interestamount = parseFloat(interest.value);
		const yearstotal = parseFloat(years.value);
	  ...
	  if (isFinite(monthly)) {
		...
		totalPayment.textContent = calculatedPayments;
		sliderValue.textContent = principal;
		sliderValue2.textContent = interestamount;
		sliderValue3.textContent = yearstotal;
		loanyear.textContent = yearstotal;
		pamount.textContent = interestamount;
		totalloanamount.textContent = (monthly * calculatedPayments).toFixed(2);
...
// emi calculater
$("#amount2").on("input change", function() {
